...
const aboutDefaults: AboutData = {
  whoWeAre: "Atlasia is a premier industry immersion bootcamp designed to bridge the gap between academic learning and corporate reality. We are associated with more than 20+ clients across multiple industries.",
